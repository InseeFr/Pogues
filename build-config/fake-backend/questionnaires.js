module.exports = [
        ...
        Child: [
          {
            Response: [
              {
                CollectedVariableReference: 'jbcgfvir',
                id: 'jbgdhaht',
                mandatory: false,
                Datatype: {
                  Pattern: '',
          ...
          },
          {
            Response: [
              {
                CollectedVariableReference: 'jbcgm0ip',
                id: 'jbgd3set',
                mandatory: false,
                Datatype: {
                  typeName: 'BOOLEAN',
          ...
          },
          {
            ...
            Child: [
              ...
              },
              {
                Response: [
                  {
                    CollectedVariableReference: 'jbcgcy2x',
                    id: 'jbgdjy8h',
                    mandatory: false,
                    Datatype: {
                      Maximum: 99,
              ...
              },
              {
                Response: [
                  {
                    CollectedVariableReference: 'jbcgbg33',
                    id: 'jbgdih2z',
                    mandatory: false,
                    Datatype: {
                      typeName: 'DATE',
                ...
                depth: 3,
                FlowControl: [],
                Label: ['When was the first episode of the Simpsons?'],
                id: 'j334cyqb',
                Declaration: [
                  {
                    declarationType: 'COMMENT',
              ...
              },
              {
                Response: [
                  {
                    CollectedVariableReference: 'jbcgieyw',
                    id: 'jbgddnrd',
                    mandatory: false,
                    Datatype: {
                      Maximum: 99,
        ...
        Child: [
          {
            Response: [
              {
                CollectedVariableReference: 'jbcgasbh',
                id: 'jbgdjdkn',
                mandatory: true,
          ...
          },
          {
            Response: [
              {
                CollectedVariableReference: 'jbcg9yr6',
                id: 'jbgd8ghp',
          ...
          },
          {
            Response: [
              {
                CollectedVariableReference: 'jbcgpija',
                id: 'jbgdkd7v',
        ...
        Child: [
          {
            Response: [
              {
                CollectedVariableReference: 'jbdxewlq',
                id: 'jbgd8qmn',
                Datatype: {
                  typeName: 'BOOLEAN',
                  type: 'BooleanDatatypeType',
          ...
          },
          {
            Response: [
              {
                CollectedVariableReference: 'jbdxtl1d',
                id: 'jbgdb3jx',
                CodeListReference: 'jbdxh138',
                Datatype: {
                  Pattern: '',
                  typeName: 'TEXT',
                  visualizationHint: 'RADIO',
          ...
          },
          {
            Response: [
              {
                CollectedVariableReference: 'jbdy4nhp',
                id: 'jbgd6p0k',
                CodeListReference: 'jbdxh138',
                Datatype: {
                  Pattern: '',
          ...
          },
          {
            Response: [
              {
                CollectedVariableReference: 'jbdy3nh7',
                id: 'jbgd7fr6',
                CodeListReference: 'jbdxricm',
                Datatype: {
                  Pattern: '',
                  typeName: 'TEXT',
                  visualizationHint: 'CHECKBOX',
            ...
            Child: [
              {
                Response: [
                  {
                    CollectedVariableReference: 'jbgdnfk7',
                    id: 'jbgde5yl',
                    Datatype: {
                      Maximum: 100,
                      Minimum: 0,
                ...
                Control: [
                  {
                    Description: 'Total of percentages',
                    Expression:
                      '$PERCENTAGE_EXPENSES11 + $PERCENTAGE_EXPENSES21 + $PERCENTAGE_EXPENSES31 + $PERCENTAGE_EXPENSES41 + $PERCENTAGE_EXPENSES51 + $PERCENTAGE_EXPENSES61 + $PERCENTAGE_EXPENSES71 + $PERCENTAGE_EXPENSES81 + $PERCENTAGE_EXPENSES91 + $PERCENTAGE_EXPENSES101 != 100',
                    criticity: 'ERROR',
                    FailMessage:
            ...
            Child: [
              {
                Response: [
                  {
                    CollectedVariableReference: 'jbgd9vqv',
                    id: 'jbgd8tyr',
                    CodeListReference: 'jbdyh6b5',
                    Datatype: {
                      Pattern: '',
                      typeName: 'TEXT',
                      visualizationHint: 'DROPDOWN',
            ...
            Child: [
              {
                Response: [
                  {
                    CollectedVariableReference: 'jbgd1zxu',
                    id: 'jbgd92mb',
                    Datatype: {
                      typeName: 'BOOLEAN',
                      type: 'BooleanDatatypeType',
        ...
        Child: [
          {
            Response: [
              {
                CollectedVariableReference: 'jbgd3fkz',
                id: 'jbgdl5jb',
                Datatype: {
                  Pattern: '',
                  typeName: 'TEXT',
  ...
  },
  {
    ...
    agency: 'fr.insee',
    genericName: 'QUESTIONNAIRE1',
    Label: ['Questionnaire SIMPSONS 1'],
    declarationMode: ['CAWI'],
    Name: 'SIMPSONS',
    Variables: {
      Variable: [
