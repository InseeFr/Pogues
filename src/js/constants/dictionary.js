export default {
  ...
  noGoToYet: { 'en': 'No goTo yet', 'fr': 'Aucune redirection définie' },
  ...
  disjoignable: {'en': 'Detachable statement', 'fr': 'Déclaration détachable'},
  goTo: {'en': 'Goto', 'fr': 'Redirections'},
  defineGoTo: {'en': 'Add a goto', 'fr': 'Ajouter une redirection'},
