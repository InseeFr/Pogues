        ...
        return (
            <div className={classDropDown} >
                ...
                <ul className={classDropDownList}>
                    <li>
                        <a href="#" onClick={e => this.visualize(e, 'html')}> {Dictionary.VISUALIZE_WEB} </a>
                    </li>
                    <li>
                        <a href="#" onClick={e => this.visualize(e, 'pdf')}>{Dictionary.VISUALIZE_PDF}</a>
                    </li>
                    <li>
                        <a href="#" onClick={e => this.visualize(e, 'spec')}>{Dictionary.VISUALIZE_SPECIFICATION}</a>
                    </li>
                </ul>
            </div >
        );
