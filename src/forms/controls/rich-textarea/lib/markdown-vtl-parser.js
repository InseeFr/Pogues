...
Renderer.prototype.code = function(text, lang) {
  ...
  const codeNode = new ElementNode('code', attributes, [new TextNode(text)]);
  ...
  switch (this.token.type) {
    ...
    case 'list_item_start': {
      ...
      while (this.next().type !== 'list_item_end') {
        body.appendChild(this.token.type === 'text' ? this.parseText() : this.tok());
      }
