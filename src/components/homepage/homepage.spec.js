...
describe('<HomePage />', () => {
  ...
  it('should render <QuestionnaireList /> component', () => {
    expect(wrapper.find('QuestionnaireList').length).toBe(1);
  });

  it('should render a "new questionnaire button"', () => {
    expect(wrapper.find('button#questionnaire-new').length).toBe(1);
  });

  it('should render a "show my team questionnaires button"', () => {
    expect(wrapper.find('button#questionnaires-team').length).toBe(1);
  });

  it('should render a "show Insee questionnaires button"', () => {
