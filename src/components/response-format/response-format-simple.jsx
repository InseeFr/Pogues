...
import ResponseFormatDatatypeNumeric from 'components/response-format/response-format-datatype-numeric';
import ResponseFormatDatatypeText from 'components/response-format/response-format-datatype-text';
