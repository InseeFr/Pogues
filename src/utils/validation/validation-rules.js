...
export const questionRules = {
  ...
  [`${RESPONSE_FORMAT}.${SIMPLE}.${NUMERIC}.minimum`]: [value => minValue(0)(value)],
  [`${RESPONSE_FORMAT}.${SIMPLE}.${NUMERIC}.maximum`]: [value => minValue(1)(value)],
...
export const declarationRules = {
  [`${DECLARATIONS}.label`]: [value => required(value) && Dictionary.validation_declaration_label],
};
...
export const calculatedVariableRules = {
  [`${CALCULATED_VARIABLES}.label`]: [value => required(value) && Dictionary.validation_calculatedvariable_label],
