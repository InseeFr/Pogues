...
const mapStateToProps = (state, { formName, selectorPathParent, fieldOrigin, fieldTarget }) => {
...
const AssociatedFieldsContainer = connect(mapStateToProps, mapDispatchToProps)(AssociatedFields);
