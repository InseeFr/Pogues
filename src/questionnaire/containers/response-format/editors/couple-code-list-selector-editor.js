...
function CoupleCodeListSelector({ id, questionnaireId, disabled, select, create, locale, edited }, toggleOrSet) {
  return {
    codeListSelector: (
      <CodeListSelector
        id={id}
    ...
    codeListEditor: id && edited ? <CodeListEditor id={id} locale={locale} /> : null,
  };
}

export default CoupleCodeListSelector;
