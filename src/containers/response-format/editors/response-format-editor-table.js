...
class TableResponseFormatEditor extends Component {
  static propTypes = {
  ...
  render() {
    ...
    const { codeListSelector: codeListSelectorPrimary, codeListEditor: codeListEditorPrimary } = coupleEditorSelector(
      {
          ...
          <div className="col-sm-7">
            <label className="radio-inline">
              <input
                ...
                onChange={e => updateFormat({ firstInfoAsAList: !e.target.checked })}
              />
              {locale.codeList}
            </label>
            <label className="radio-inline">
        ...
        <div className="form-group">
          ...
          <div className="col-sm-7">
            <label className="radio-inline">
              <input
                type="radio"
                checked={firstInfoTotal}
                onChange={e => updateFormat({ firstInfoTotal: e.target.checked })}
              />
              {locale.yes}
            </label>
            <label className="radio-inline">
            ...
            <div className="col-sm-2">
              <div className="checkbox">
                <input
                  ...
                  onChange={e => updateFormat({ hasTwoInfoAxes: e.target.checked })}
                />
              </div>
            </div>
          </div>}
            ...
            <div className="form-group">
              ...
              <div className="col-sm-7">
                <label className="radio-inline">
                  <input
                    type="radio"
                    checked={scndInfoTotal}
                    onChange={e => updateFormat({ scndInfoTotal: e.target.checked })}
                  />
                  {locale.yes}
                </label>
                <label className="radio-inline">
...
export default TableResponseFormatEditor;
