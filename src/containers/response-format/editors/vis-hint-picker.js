...
import { DATATYPE_VIS_HINT as visHintMap } from 'constants/constants-mapping';

function VisHintPicker({ visHint, select, disabled, locale }) {
...
VisHintPicker.defaultProps = {
  disabled: false,
};

export default VisHintPicker;
