...
## [3.8.1](https://github.com/InseeFr/Pogues/releases/tag/3.8.1) - 2026-09-07
...
- Add short name field in questionnaire details form

### Fixed

- fix outline visibility on button when focused

## [3.7.1](https://github.com/InseeFr/Pogues/releases/tag/3.7.1) - 2026-08-04
...
- Nomenclature page now displays the nomenclature theme, reference year and version.![alt text](image.png)
...
## [3.3.0](https://github.com/InseeFr/Pogues/releases/tag/3.3.0) - 2026-06-11
