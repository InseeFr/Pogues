import { Switch as UISwitch } from '@base-ui-components/react/switch';
...
export default function Switch({
  ...
  return (
    <div>
      ...
      >
        <UISwitch.Thumb className="aspect-square h-full rounded-full bg-white shadow-[0_0_1px_1px,0_1px_1px,1px_2px_4px_-1px] shadow-gray-100 transition-transform duration-150 data-[checked]:translate-x-4 dark:shadow-black/25" />
      </UISwitch.Root>
    </div>
  );
}
