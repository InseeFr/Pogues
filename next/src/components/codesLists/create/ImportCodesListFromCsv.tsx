...
import { validateCodeListCsvFile, convertCsvToFormValues } from '@/utils/csvValidation';
...
export default function ImportCodesListFromCsv({
    ...
    const handleFileUpload = async (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            ...
            if (!validationResult.success) {
                toast.error(validationResult.error || t('codesList.import.genericValidationError'));
                setParseError(validationResult.error || t('codesList.import.genericValidationError'));
                return;
            }
    ...
    const handleImport = () => {
        ...
        try {
            ...
            setParseError(error instanceof Error ? error.message : t('codesList.import.conversionError'));
        }
    };
